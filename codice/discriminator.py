...
def train_discriminator(model, x_train, y_train, x_val, y_val, epochs):
	...
	early_stop = EarlyStopping(monitor='val_acc', min_delta=0, patience=15, verbose=0, mode='auto')
...
if __name__ == "__main__":
	...
	x_train, y_train, x_val, y_val, x_test, y_test = my_utils.load_discriminator_data_v2(train_dataset="DS_DISCRIMINATOR/DS.L.ALL.txt", test_dataset="DS_DISCRIMINATOR/DS.B.ALL.txt")

	#create discriminator model
	model = build_discriminator(input_shape=x_train.shape[1:], res_block_num=50, attention_on=False)
	...
	trained_model.save('discriminator_model.h5')